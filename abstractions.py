...
def make_review(restaurant_name, rating):
    ...
    return [restaurant_name, rating] #review
...
def restaurant_ratings(restaurant):
    ...
    #restaurant[4] == reviews = [make_review(name, rating), make_review(name, rating)]
    lst = []
    for review in restaurant[4]:
        rating_list = [review_rating(review)]
        lst = lst + rating_list
    return lst
